...
const api = Cosmic()
const COSMIC_BUCKET = process.env.COSMIC_BUCKET || 'node-starter-localization'
...
const importObjects = async () => {
	...
	if(res.status === 'empty') {
		...
		console.log("Contact is imported. Please enable localization (en,de) for your Object Type")
	}
}
importObjects()